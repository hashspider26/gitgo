                ...
                <div className="bg-white dark:bg-black rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
                    <table className="w-full text-left text-sm">
                        <thead className="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800">
                            <tr>
                                <th className="px-3 py-3 sm:px-6 sm:py-4 font-medium text-zinc-900 dark:text-white w-14 sm:w-20">Image</th>
                                <th className="px-3 py-3 sm:px-6 sm:py-4 font-medium text-zinc-900 dark:text-white">Title</th>
                                <th className="px-3 py-3 sm:px-6 sm:py-4 font-medium text-zinc-900 dark:text-white">Price</th>
                                ...
                                <th className="px-3 py-3 sm:px-6 sm:py-4 font-medium text-zinc-900 dark:text-white text-right">Actions</th>
                            </tr>
                        </thead>
                            ...
                            {products.map((product: any) => {
                                ...
                                return (
                                    <tr key={product.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors">
                                        ...
                                        <td className="px-3 py-3 sm:px-6 sm:py-4 font-medium text-zinc-900 dark:text-white text-xs sm:text-sm max-w-[120px] sm:max-w-none truncate sm:whitespace-normal">
                                            {product.title}
                                        </td>
                                        <td className="px-3 py-3 sm:px-6 sm:py-4 text-zinc-600 dark:text-zinc-400 text-xs sm:text-sm whitespace-nowrap">
